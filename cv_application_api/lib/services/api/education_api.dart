...
Future<Education?> getUserEducation({required BuildContext context}) async {
...
Future<Education?> postUserEducation(Map body,
...
Future<Education?> deleteUserEducation(Map body,
    {required BuildContext context}) async {
  final SharedPreferences prefs = await SharedPreferences.getInstance();
  String token = prefs.getString("token")!;
