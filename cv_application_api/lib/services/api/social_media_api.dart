...
Future<SocialMedia?> getUserSocialMedia({required BuildContext context}) async {
  ...
  if (response.statusCode == 200) {
    return SocialMedia.fromJson(json.decode(response.body));
...
Future<SocialMedia?> postUserSocialMedia(Map body,
...
Future<SocialMedia?> deleteUserSocialMedia(Map body,
    {required BuildContext context}) async {
  final SharedPreferences prefs = await SharedPreferences.getInstance();
  String token = prefs.getString("token")!;
