...
class EditSkillsView extends StatefulWidget {
  const EditSkillsView({super.key});

  @override
  State<EditSkillsView> createState() => _EditSkillsViewState();
}

class _EditSkillsViewState extends State<EditSkillsView> {
  @override
